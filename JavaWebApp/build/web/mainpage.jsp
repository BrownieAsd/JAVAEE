...
<html>
    ...
    <H1>       
        ...
        PreparedStatement ps = conn.prepareStatement("SELECT p.id,p.name,p.producer,c.Name,p.price,p.Photo,p.Description FROM Products p, Consoles c Where p.console=c.id;");
        ...
        String image = x.getString(6); 
        String description = x.getString(7); 
